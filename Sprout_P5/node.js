...
class Node {
	...
	Node (args) {
		...
		this.start = args.p.get() || p.createVector();
		this.location = args.p.get() || p.createVector();
		this.velocity = args.v.get() || p.createVector();
		// Public floats
		this.timerstart = args.timerstart || 0;
		...
		var maxforce = random(0.8,1);    // Default 0.05
